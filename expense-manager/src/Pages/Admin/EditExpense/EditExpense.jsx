...
const EditExpense = (data) => {
    ...
    const [expenseInfo, setInfo] = useState({ userId:"",id:"",dateAndTime: "", amount: "", currency: "", category: "Home", description: "" })
    ...
    const handleSubmit = async(e) => {
        e.preventDefault();
        setProcessing(true);
        let res = await axios.put("https://expense-manager01.herokuapp.com/admin/expense/edit",expenseInfo);
        if(res.data.success){
            history.push('dashboard')
        }else{
